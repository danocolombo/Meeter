...
export const processLogin2 = (username, password) => async (dispatch) => {
    ...
    var authenticationDetailsX = new AuthenticationDetails(authenticationDataX);
    var poolDataX = {
            ...
            onSuccess: (data) => {
                ...
                try {
                    ...
                    try {
                        ...
                        let api2use =
                            process.env.REACT_APP_MEETER_API + '/clients';
                        ...
                        if (clientInfoRes.status === 200) {
                            ...
                            if (
                                Object.keys(clientInfoRes.data.body).length > 0
                            ) {
                                let clientInfo =
                                    clientInfoRes.data.body.Items[0];
                                //confirm we have defaultGroups and save
                                if (
                                    clientInfo.hasOwnProperty('defaultGroups')
                                ) {
                                    dispatch({
                                ...
                                if (
                                    clientInfo.hasOwnProperty('clientConfigs')
                                ) {
                                    dispatch({
