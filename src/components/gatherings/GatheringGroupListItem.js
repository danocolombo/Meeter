    ...
    return (
        <>
            <div className='group-list-component__wrapper'>
                <div className='group-list-component__row'>
                    <div className={'group-list-component__definitions'}>
                        <NavLink
                            ...
                            className={'group-list-compoment__nav-link'}
                        >
                            {
                                gender === 'f'
                                    ? "Women's " + title
                        ...
                        <div
                            className={
                                parseInt(attendance) > 0
                                    ? 'group-list-component__attendance'
                                    : null
                            }
                        >
                            {parseInt(attendance) > 0 ? attendance : null}
                        </div>
                    </div>
                    <div>
                        {role !== 'guest' ? (
                            <i
                                className={
                                    'fa fa-trash gather-component__trash-style'
                                }
                ...
                {facilitator ? (
                    <div className='group-list-component__row'>
                        <div className='group-list-component__facilitator'>
                            {facilitator}
                        </div>
                    </div>
                ) : null}
                <div className='group-list-component__row'>
                    <div className={'group-list-component__location'}>
                        {location}
                    </div>
                </div>
            </div>
